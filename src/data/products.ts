...
export const products: Record<Lang, Record<ProductKey, Product>> = {
  en: {
    group: {
      ...
      hero: 'Three live practices a week. Strength, mobility, consistency.',
    ...
    individual: {
      ...
      hero: '75 minutes built around your body and your goals.',
    ...
    course: {
      ...
      hero: 'Eight weeks. Short practices. A clear progression.',
  ...
  fr: {
    group: {
      ...
      hero: 'Trois pratiques en direct par semaine. Force, mobilité, régularité.',
    ...
    individual: {
      ...
      hero: '75 minutes construites autour de votre corps et de vos objectifs.',
    ...
    course: {
      ...
      hero: 'Huit semaines. Des pratiques courtes. Une progression claire.',
  ...
  ua: {
    group: {
      ...
      hero: 'Три живі практики на тиждень. Сила, мобільність, регулярність.',
    ...
    individual: {
      ...
      hero: '75 хвилин навколо твого тіла та твоїх цілей.',
    ...
    course: {
      ...
      hero: 'Вісім тижнів. Короткі практики. Зрозуміла прогресія.',
